...
public:
	...
	static inline const char* KUnlimitedVigorLabel = "";
	static inline const char* kUnlimitedTalentsLabel = "";
	static inline const char* kUnlimitedWeightLabel = "";
	static inline const char* kUnlimitedMedallionLabel = "";
	static inline const char* kUnlimitedAdrenalineLabel = "";
	static inline const char* kNoToxicityLabel = "";
	static inline const char* kFreeCamera = "";
	static inline const char* kMovementChangerLabel = "";
	static inline const char* kFovChangerLabel = "";
	static inline const char* kGameSpeedChangerLabel = "";
