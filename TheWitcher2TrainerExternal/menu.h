...
#include "../TheWitcher2TrainerExternal/functions.h"

#define STB_IMAGE_IMPLEMENTATION
#define GL_CLAMP_TO_EDGE 0x812F

#define IMGUI_WINDOW_W 870
#define IMGUI_WINDOW_H 540
...
public:
	...
	static inline std::array<int, 12> key_bind_ = { 97, 98, 99, 100, 101, 102, 103, 104, 105, 96, 111, 106 };
};